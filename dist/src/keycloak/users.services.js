...
exports.KeycloakAdminUsersService = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
let KeycloakAdminUsersService = class KeycloakAdminUsersService {
    config;
    kc = null;
    constructor(config) {
        this.config = config;
...
exports.KeycloakAdminUsersService = KeycloakAdminUsersService;
exports.KeycloakAdminUsersService = KeycloakAdminUsersService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], KeycloakAdminUsersService);
