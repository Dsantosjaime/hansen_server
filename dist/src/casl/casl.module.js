...
const casl_guard_1 = require("./casl.guard");
...
exports.CaslModule = CaslModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [casl_ability_factory_1.CaslAbilityFactory, casl_guard_1.CaslGuard],
        exports: [casl_ability_factory_1.CaslAbilityFactory, casl_guard_1.CaslGuard],
    })
], CaslModule);
