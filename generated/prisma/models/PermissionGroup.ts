...
export interface PermissionGroupDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more PermissionGroups that matches the filter.
   * @param {PermissionGroupFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const permissionGroup = await prisma.permissionGroup.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  ...
  /**
   * Perform aggregation operations on a PermissionGroup.
   * @param {PermissionGroupAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const permissionGroup = await prisma.permissionGroup.aggregateRaw({
   *   pipeline: [
